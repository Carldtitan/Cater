...
const SAMPLES = [
  ...
  },
  {
    label: "中文",
    value:
      "我叫 Jordan Lee。我的电话号码是 415-555-0184。事故发生在2026年8月14日，地点是旧金山 Oak 街和第十二街的路口。我当时在红灯前停车，后车追尾了我的车。我认为后车司机造成了事故。事故后我的颈部和下背部疼痛。当天晚上我去了急诊。警方出具了事故报告。对方有保险，保险公司是 State Farm。我目前没有律师代理这起事故。",
  },
] as const;
